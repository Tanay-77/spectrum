...
const cardData: BentoCardProps[] = [
  {
    ...
    description: 'Instantly see how your color palette makes people feel',
    label: 'AI Powered'
  },
  {
    color: '#060010',
    title: 'AI Palette Evaluator',
    description: 'Upload designs and get intelligent color recommendations',
    label: 'Smart Analysis'
  },
  {
    color: '#060010',
    title: 'Creative Dashboard',
    description: 'Visualize your brand\'s personality evolution',
    label: 'Real-time'
  },
  {
    color: '#060010',
    title: 'Color Psychology',
    description: 'Understand emotional impact of every hue',
    label: 'Science-based'
  },
  {
    color: '#060010',
    title: 'Harmony Checker',
    description: 'Ensure perfect balance in your color schemes',
    label: 'Automated'
  },
  {
    color: '#060010',
    title: 'Brand Intelligence',
    description: 'Design with confidence using data-driven insights',
    label: 'Enterprise'
  }
];
        ...
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            ...
            const cardStyle = {
              ...
              '--glow-radius': '200px',
              ...(index === 2 && {
                backgroundImage: 'url(https://i.pinimg.com/originals/4f/a3/ac/4fa3acb120355a8754dbd8065d2e60cf.gif)',
